...
from DBR import protoAugSSL
from ResNet import resnet18_cbam
from myNetwork import network
from iCIFAR100 import iCIFAR100

parser = argparse.ArgumentParser(description='A Dual Bias Reduction Framework for Class-Incremental Learning')
...
parser.add_argument('--protoAug_mode', default='I', type=str, help='E(explicit), I(implicit)')
...
parser.add_argument('--old_number', default=2.5, type=float, help='1|1.5|2|2.5')
parser.add_argument('--ratio', default=2.5, type=float, help='1|1.5|2|2.5|3')
...
def main():
    ...
    file_name = args.data_name + '_' + args.protoAug_mode + '_' + str(args.fg_nc) + '_' + str(args.task_num) + '*' + str(task_size)
